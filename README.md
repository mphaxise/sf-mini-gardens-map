...
- One static map discovery page with neighborhood filtering, two verified canonical entries, queued submission workflow, moderator status controls, and local draft export
